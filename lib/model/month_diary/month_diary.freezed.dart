...
class _$_MonthDiary implements _MonthDiary {
  ...
  @override
  String toString() {
    return 'MonthDiary(month: $month, monthNumber: $monthNumber, cardColor: $cardColor, frontImage: $frontImage, backImage: $backImage, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
