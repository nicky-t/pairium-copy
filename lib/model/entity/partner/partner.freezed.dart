...
class _$PartnerTearOff {
  ...
  _Partner call(
    ...
    return _Partner(
      userIds: userIds,
      submitRequestUser: submitRequestUser,
      receiveRequestUser: receiveRequestUser,
      requestStatus: requestStatus,
...
mixin _$Partner {
  ...
  String? get submitRequestUser => throw _privateConstructorUsedError;
  String? get receiveRequestUser => throw _privateConstructorUsedError;
...
class _$PartnerCopyWithImpl<$Res> implements $PartnerCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? submitRequestUser = freezed,
    Object? receiveRequestUser = freezed,
    ...
    return _then(_value.copyWith(
      userIds: userIds == freezed
          ...
          : userIds // ignore: cast_nullable_to_non_nullable
              as List<String>,
      submitRequestUser: submitRequestUser == freezed
          ? _value.submitRequestUser
          : submitRequestUser // ignore: cast_nullable_to_non_nullable
              as String?,
      receiveRequestUser: receiveRequestUser == freezed
          ? _value.receiveRequestUser
          : receiveRequestUser // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_Partner implements _Partner {
  const _$_Partner(
      ...
      this.submitRequestUser,
      this.receiveRequestUser,
      this.requestStatus,
  ...
  @override
  final String? submitRequestUser;
  @override
  final String? receiveRequestUser;
  @override
  ...
  @override
  String toString() {
    return 'Partner(userIds: $userIds, submitRequestUser: $submitRequestUser, receiveRequestUser: $receiveRequestUser, requestStatus: $requestStatus, anniversary: $anniversary, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Partner &&
            ...
            (identical(other.submitRequestUser, submitRequestUser) ||
                const DeepCollectionEquality()
                    .equals(other.submitRequestUser, submitRequestUser)) &&
            (identical(other.receiveRequestUser, receiveRequestUser) ||
                const DeepCollectionEquality()
                    .equals(other.receiveRequestUser, receiveRequestUser)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(submitRequestUser) ^
      const DeepCollectionEquality().hash(receiveRequestUser) ^
