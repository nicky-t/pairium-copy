...
import '../../../application/state/month_diary_state/month_diary_state_provider.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final partnerStream = ref.watch(partnerStreamProvider).data?.value;
    final monthDiaryState =
        ref.watch(monthDiaryControllerProvider(partnerStream));

    final selectedYear = ref.watch(selectedYearStateProvider);
    final frontCacheImageFile = ref.watch(frontCacheImageFileProvider);
    final backCacheImageFile = ref.watch(backCacheImageFileProvider);

    final monthDiaryController =
        ref.read(monthDiaryControllerProvider(partnerStream).notifier);
              ...
              child: PreloadPageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FlipMonthCard(
                    ...
                    backCacheImageFile: backCacheImageFile.state,
                    toDayCardList: () {
                    ...
                    openSetting: () => _showBottomSheet(
                      ...
                      updateMonthDairy: ({
                        ...
                        if (monthDiaryDoc == null) {
                          await monthDiaryController.setMonthDairyDoc(
                            year: selectedYear,
                            month: selectedMonth,
                            monthDiaryDoc: monthDiaryDoc,
                            frontImage: frontCacheImageFile.state,
                            backImage: backCacheImageFile.state,
                            backgroundColor: backgroundColor,
                            textColor: textColor,
                          );
                        } else {
                          await monthDiaryController.updateMonthDairyDoc(
                            month: selectedMonth,
                            monthDiaryDoc: monthDiaryDoc,
                            frontImage: frontCacheImageFile.state,
                            backImage: backCacheImageFile.state,
