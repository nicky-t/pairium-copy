...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    ...
    TabIconData(
      type: BottomNavigatorType.calendar,
      animationController: null,
    ),
    TabIconData(
      type: BottomNavigatorType.favorite,
      animationController: null,
    ),
    TabIconData(
...
class _TabIconsState extends ConsumerState<TabIcons>
  ...
  Widget build(BuildContext context) {
    ...
    final controller =
        ref.read(currentBottomNavigatorControllerProvider.notifier);
      ...
      child: InkWell(
        ...
        onTap: () {
          if (widget.tabIconData.type != currentScreenState) {
            controller.setCurrentBottomNavigator(widget.tabIconData.type.index);
            setAnimation();
          }
        },
        child: Center(
